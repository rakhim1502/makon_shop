        ...
        <div className="min-h-screen bg-neutral-50 py-4 md:py-8 px-3 md:px-4">
            <div className="max-w-4xl mx-auto">
                <div className="mb-4 md:mb-8">
                    <h1 className="text-xl md:text-3xl font-bold text-neutral-900">Yangi jihoz qo'shish</h1>
                    <p className="text-sm md:text-base text-neutral-600 mt-1">Katalogga yangi mahsulot qo'shing</p>
                </div>
                    ...
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 pt-4 md:pt-6 border-t border-neutral-200">
                            <motion.button
                                type="submit"
                                disabled={loading}
                                className={`flex-1 py-3 md:py-4 rounded-lg md:rounded-xl font-bold text-white transition-all text-sm md:text-base ${loading
                            ...
                            >
                                {loading ? 'Saqlanmoqda...' : '✓ Jihozni saqlash'}
                            </motion.button>
